  ...
  <div class="container-fluid" style="position: fixed">
      <div class="m-auto">
          ...
          <div class="row justify-content-between">
              <form class="col-12 col-md-6 pb-3 pb-md-0" method="POST" action="belanja.php">
              ...
              <div class="col-12 col-sm-8 sm-2 col-md-4">
                  <ul class="list-group">
          ...
          $list_produk = array("TV" => 4200000, "KULKAS" => 3100000, "MESIN CUCI" => 3800000);
          ...
          if (!empty($submit)) {
              ...
              if (!empty($jumlah)) {
                  echo '</br>Total Belanja : ' . $list_produk[$produk] * $jumlah;
              } else {
