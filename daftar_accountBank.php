...
<body>
  <div class="container" style="position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%);">
    <table class="example display nowrap table-striped table-dark table-bordered table" style="width:100%">
      <thead>
        <tr>
          <th>No</th>
          <th>No.Account</th>
    ...
    <br><hr>
    <p><b>Transaksi</b>
      <br>Ahmad nabung 1.000.000
      <br>Ahmad transfer 1.500.000 ke kurniawan dan 500.000 ke Budi
      <br>Budi tarik uang 2.500.000
    </p>
    <hr><br>
